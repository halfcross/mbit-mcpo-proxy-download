#!/usr/bin/env bash
# MindBehindMCP — macOS one-line installer
...
echo "MindBehindMCP · MindBehind IT — one-line install"
echo ""
echo " This will:"
...
DMG_PATH="$TMPDIR/mindbehindmcp.dmg"
...
echo ""
echo " ════════════════════════════════════════"
echo " Done. Open MindBehindMCP from Applications or Spotlight."
